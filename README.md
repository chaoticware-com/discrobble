...
- Repository status: public GitHub repo created under `chaoticware-com`, with `main` protected and initial GitHub Actions/release workflow skeletons added; docs-first bootstrap is still in progress.
